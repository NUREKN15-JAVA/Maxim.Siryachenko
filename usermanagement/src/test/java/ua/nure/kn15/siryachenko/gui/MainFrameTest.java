...
import ua.nure.kn15.siryachenko.db.MockDaoFactory;
import ua.nure.kn15.siryachenko.gui.MainFrame;
...
public class MainFrameTest extends JFCTestCase {
	 ...
	 * in testEditUser()
	 */
	private final User REAL_USER = new User(new Long(500), "John", "Doe", NOW);
	...
	private final User UPDATED_USER = new User(new Long(500), "Andrew", "Doe", NOW);
	...
	/**
	 * Test for deleteButton on the BrowsePane. Delete selected user from userTable.
	 */
	public void testDeleteUser() {
		...
		mockUserDao.expectAndReturn("find", REAL_USER.getId(), deleteUsers.get(REAL_USER_LIST_POSITION));
